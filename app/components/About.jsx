  ...
  return (
    <section className="py-12 sm:py-16 md:py-20 bg-[#fafafa] text-center px-4 sm:px-6 md:px-8 lg:px-10">
      <div className="max-w-[1390px] mx-auto">
        <div className="flex flex-col sm:flex-row justify-center sm:justify-evenly items-center gap-4 sm:gap-6 mb-8 sm:mb-12 md:mb-16">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-[40%_60%] gap-6 sm:gap-8 md:gap-10 mt-8 sm:mt-12 md:mt-16 lg:mt-25">
            ...
            <div className="bg-white rounded-[12px] p-4 sm:p-5 md:p-6 space-y-6 sm:space-y-8 md:space-y-40 overflow-hidden">
              ...
              <div className="overflow-hidden w-full">
                <div className="slider flex items-center gap-4 sm:gap-6">
                  <Image src={logo1} alt="logo1" width={105} height={16} className="w-20 sm:w-24 md:w-[105px] h-auto" />
                  <Image src={logo2} alt="logo2" width={105} height={16} className="w-20 sm:w-24 md:w-[105px] h-auto" />
                  <Image src={logo3} alt="logo3" width={105} height={16} className="w-20 sm:w-24 md:w-[105px] h-auto" />
